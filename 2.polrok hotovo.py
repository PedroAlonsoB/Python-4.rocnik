...
print("R˝chlosù insertion sortu je: ",cas_insertion, "sek.")
print("R˝chlosù quick sortu je: ",cas_quick, "sek.")
print("R˝chlosù selection sortu je: ",cas_selection, "sek.")
print("R˝chlosù bubble sortu je: ",cas_bubble, "sek.")
print("R˝chlosù merge sortu je: ",cas_merge, "sek.")